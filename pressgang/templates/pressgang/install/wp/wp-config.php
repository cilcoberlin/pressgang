...
$base = '{{ blog_path }}';
define('VHOST', '{{ use_subdomains|yesno:"yes,no" }}');
define('DOMAIN_CURRENT_SITE', '{{ server_base }}');
define('PATH_CURRENT_SITE', '{{ blog_path }}');
...
define('SUBDOMAIN_INSTALL', {{ use_subdomains|yesno:"true,false" }});
define('DOMAIN_CURRENT_SITE', '{{ server_base }}');
define('PATH_CURRENT_SITE', '{{ blog_path }}');
define('SITE_ID_CURRENT_SITE', 1);
define('BLOG_ID_CURRENT_SITE', 1);
